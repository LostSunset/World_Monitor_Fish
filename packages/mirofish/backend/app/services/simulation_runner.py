...
class SimulationRunner:
    ...
    @staticmethod
    def _validate_simulation_id(simulation_id: str):
    ...
    @classmethod
    def _safe_sim_dir(cls, simulation_id: str) -> str:
        """Return a validated simulation directory path."""
        cls._validate_simulation_id(simulation_id)
        sim_dir = os.path.join(cls.RUN_STATE_DIR, simulation_id)
        real_sim_dir = os.path.realpath(sim_dir)
        real_base_dir = os.path.realpath(cls.RUN_STATE_DIR)
        if not real_sim_dir.startswith(real_base_dir + os.sep) and real_sim_dir != real_base_dir:
            raise ValueError(f"Path traversal detected for simulation_id: {simulation_id}")
        return sim_dir
    ...
    def start_simulation(
        ...
        # 加载模拟配置
        sim_dir = cls._safe_sim_dir(simulation_id)
