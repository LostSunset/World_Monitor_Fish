...
export function getClientIp(request) {
  // Prefer platform-set headers (not spoofable) before falling back to x-forwarded-for.
  return (
...
export async function verifyTurnstile({
  ...
  if (!secret) {
    ...
    const isExplicitDevelopment = process.env.VERCEL_ENV === 'development' || process.env.NODE_ENV === 'development';
